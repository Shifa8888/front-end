...
const Goals = () => {
  ...
  return (
    <Layout title="Ranks">
      {/* Current Goal Status */}
      <div className="mb-2">
        <h4 className="text-white mb-1 opacity-95" style={{ fontWeight: 'normal' }}>Current Goal Status</h4>
      ...
      {/* Reward Requirements */}
      <div className="mb-4">
        <h4 className="text-white  mb-1 opacity-95" style={{ fontWeight: 'normal' }}>Reward Requirements</h4>
