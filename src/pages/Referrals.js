...
const Referrals = () => {
  ...
  const fetchReferralData = async () => {
    try {
      ...
      setReferralEarning(user?.referralEarnings || 0);
  ...
  return (
    <Layout title="Referrals">
      <div className="p-4">
        ...
        <div className="row g-4 mb-4">
          ...
          <div className="col-lg-6">
            <div className="wallet-card">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h5 className="text-white  mb-1 opacity-95" style={{ fontWeight: 'normal' }}>Referral Earning Wallet</h5>
          ...
          <div className="col-lg-6">
            ...
            <div className="dashboard-card mb-3">
              <h6 className="text-white mb-3 opacity-95" style={{ fontWeight: 'normal' }}>Referral Link</h6>
            ...
            <div className="dashboard-card">
              <h6 className="text-white mb-3 opacity-95" style={{ fontWeight: 'normal' }}>Referral Code</h6>
              <div className="referral-box">
        ...
        <div className="dashboard-card">
          <h5 className="text-white  mb-4 opacity-95" style={{ fontWeight: 'normal' }}>Investment Commission Structure</h5>
